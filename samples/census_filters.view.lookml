- view: census_filters
  extends: census
  fields:
  - filter: select_pwsswgt
    label: "Second stage weight (rake 6 final step weight)"
    view_label: Group Weighting Variables
    suggest_dimension: pwsswgt
  ...
  - filter: select_hrhhid
    label: "Identifier,scrambled"
    view_label: Group Household Variables
    suggest_dimension: hrhhid
  ...
  - filter: select_hwhhwgt
    label: "Household"
    view_label: Group Weighting Variables
    suggest_dimension: hwhhwgt


  - filter: select_pwfmwgt
    label: "Family"
    view_label: Group Weighting Variables
    suggest_dimension: pwfmwgt


  - filter: select_pwlgwgt
    label: "Longitudinal weight"
    view_label: Group Weighting Variables
    suggest_dimension: pwlgwgt


  - filter: select_pworwgt
    label: "Outgoing rotation weight"
    view_label: Group Weighting Variables
    suggest_dimension: pworwgt


  - filter: select_pwvetwgt
    label: "Veterans weight"
    view_label: Group Weighting Variables
    suggest_dimension: pwvetwgt
  ...
  - filter: select_pwcmpwgt
    label: "Composited final weight"
    view_label: Group Weighting Variables
    suggest_dimension: pwcmpwgt
  ...
  - filter: select_hrhhid2
    label: "Household identification number, part 2"
    view_label: Group Household Variables
    suggest_dimension: hrhhid2
  ...
  - filter: select_hwhhwtln
    label: "Line number (pulineno) of household weight donor"
    view_label: Group Household Variables
    suggest_dimension: hwhhwtln
  ...
  - filter: select_hrsample
    label: "Sample id (created in reformat)"
    view_label: Group Household Variables
    suggest_dimension: hrsample


  - filter: select_hrsersuf
    label: "Serial suffix"
    view_label: Group Household Variables
    suggest_dimension: hrsersuf
  ...
  - filter: select_pw2kwgt
    label: "2000-based final weight"
    view_label: Group Voting and Registration Supplement Variables
    suggest_dimension: pw2kwgt
